...
SCANNET_RAW_PATH = Path('/home/ubuntu/luoly/datasets/Pheno4D/')
SCANNET_OUT_PATH = Path('/home/ubuntu/luoly/datasets/Pheno4D_preprocessed/')
TRAIN_DEST = 'train'
TEST_DEST = 'test'
SUBSETS = {TRAIN_DEST: 'Tomato01' 'Tomato02' 'Tomato03' 'Tomato04' 'Tomato05'}
POINTCLOUD_FILE = '_a.txt'
BUGS = {
...
path_list = []
for in_path in SUBSETS.items():
  phase_out_path = SCANNET_OUT_PATH / 'train'
