...
class soybeanVoxelizationtestDataset(VoxelizationDataset):
  ...
  def __init__(self,
    ...
    data_root = config.soybean_test_path
...
class soybeanVoxelization5cmtestDataset(soybeanVoxelizationtestDataset):
  VOXEL_SIZE = 0.002